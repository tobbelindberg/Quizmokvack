...
## Note that the firebase server I had setup for this project is not running anymore so you can not run the project and give it a try but you can still glance at the code :)
